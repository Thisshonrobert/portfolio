        ...
        <div>
          <form ref={form} onSubmit={sendEmail} className='flex flex-col w-full md:w-1/2 mx-auto'>
            ...
            <textarea rows='10' name="message" placeholder='Type your message' 
              className='border-4 border-black dark:border-gray-700 text-black dark:text-white rounded-md focus:outline-none bg-transparent p-2 mb-2'/>
            <button className='bg-gradient-to-r from-yellow-500 to-purple-500 px-6 py-1 mx-auto shadow-md rounded-lg shadow-purple-600 hover:scale-110 duration-300'>{mailStatus?"Email Sent":"Let's Talk"}</button>
          </form>
        </div>
      </div>
    </div>
...
//action="https://getform.io/f/panvlkpa" method="POST"