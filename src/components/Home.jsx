...
function Home() {
  ...
  return (
    <div name="Home" className="bg-gradient-to-b from-black via-black to-gray-800 md:h-screen md:w-full">
      <div className="max-w-screen-lg mx-auto flex flex-col md:flex-row items-center justify-center  md:h-full px-4">
        ...
        <div className="ml-12">
          <img className=" rounded-2xl  w-2/3  md:w-full max-w-sm mx-8" src={heroimage} alt="my image" />
        </div>
      </div>
    </div>
  );
