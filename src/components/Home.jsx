    ...
    <div name="Home" className="bg-gradient-to-b from-blue-300 via-blue-200 to-blue-100 dark:from-black dark:via-black dark:to-gray-800 pl-10 sm:pl-0 w-full h-screen sm:h-screen sm:w-full">
      <div className="max-w-screen-lg mx-auto flex flex-col md:flex-row items-center justify-center h-[127%] md:h-full px-4">
        <div className="flex flex-col justify-center">
          <h2 className="text-4xl sm:text-7xl text-black dark:text-white font-bold">
            <TypeWriterEffect
              startDelay={100}
              cursorColor="black"
              typeSpeed={100}
          ...
          <p className="py-4 mx-w-md text-blue-900 dark:text-gray-500">
            I like to work on web applications using technologies like NodeJS, Express, React, MongoDB, and PostgreSQL.
          </p>
          <div>
        ...
        <div className="pl-[10%] p-4 md:ml-8 ">
